...
export default function ResetPassPage() {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-8 w-full">
      <div className="w-full max-w-md mx-auto" style={{ maxWidth: "420px" }}>
        <div className="bg-black border border-gray-800 p-6 rounded-xl shadow-xl">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold tracking-tight text-white mb-1">Reset Password</h1>
